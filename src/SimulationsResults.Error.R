...
pdf(file=paste0("results/",project,"/Results/Error/Error_main.pdf"),width=4,height=8)
...
for (pgsm in seq_along(pgsm_values)){
  ...
  pdf(file=paste0("results/",project,"/Results/Error/ErrorContractions_",pgsm_values[pgsm],".pdf"),width=12,height=12)
  ...
  pdf(file=paste0("results/",project,"/Results/Error/ErrorExpansions_",pgsm_values[pgsm],".pdf"),width=12,height=12)
  par(mfrow=c(4,3), mar=c(3,3,1,1), oma=c(6,6,3,0))
  for (scen in 13:24){
  ...
  pdf(file=paste0("results/",project,"/Results/Error/ErrorConstantSize_",pgsm_values[pgsm],".pdf"),width=12,height=4)
